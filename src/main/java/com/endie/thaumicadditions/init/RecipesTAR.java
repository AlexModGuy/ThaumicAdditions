...
public class RecipesTAR extends RecipeRegistry
{
	...
	private void infusing()
	{
		...
		addInfusionRecipe("aura_disperser", new ItemStack(BlocksTAR.AURA_DISPERSER), "TAR_AURA_DISPERSER", 4, new ItemStack(Blocks.DISPENSER), new AspectList().add(KnowledgeTAR.FLUCTUS, 30).add(Aspect.AURA, 10).add(Aspect.ALCHEMY, 20), new ItemStack(ItemsTC.mechanismComplex), AspectUtil.salt(Aspect.AURA), AspectUtil.salt(Aspect.ALCHEMY), new ItemStack(BlocksTC.shimmerleaf), new ItemStack(ItemsTC.morphicResonator), AspectUtil.salt(KnowledgeTAR.FLUCTUS), AspectUtil.salt(KnowledgeTAR.DRACO), "nitor");
		...
		addInfusionRecipe("enchanted_golden_apple", new ItemStack(Items.GOLDEN_APPLE, 1, 1), "TAR_ENCHANTED_GOLDEN_APPLE", 6, new ItemStack(Items.GOLDEN_APPLE), new AspectList().add(Aspect.DESIRE, 10).add(Aspect.LIFE, 5), new ItemStack(Blocks.GOLD_BLOCK), crystalEssence(Aspect.DESIRE), new ItemStack(Blocks.GOLD_BLOCK), crystalEssence(Aspect.DESIRE), new ItemStack(Blocks.GOLD_BLOCK), crystalEssence(Aspect.DESIRE), new ItemStack(Blocks.GOLD_BLOCK), crystalEssence(Aspect.DESIRE));
		addInfusionRecipe("mob_summoner", new ItemStack(BlocksTAR.ENTITY_SUMMONER), "TAR_MOB_SUMMONING", 5, new ItemStack(BlocksTC.metalBlockThaumium), new AspectList().add(KnowledgeTAR.DRACO, 20).add(KnowledgeTAR.EXITIUM, 10).add(Aspect.LIFE, 15).add(AspectUtil.primals(15)).add(Aspect.SOUL, 20).add(Aspect.MAN, 30).add(Aspect.BEAST, 25), new ItemStack(ItemsTAR.ENTITY_CELL), new ItemStack(ItemsTC.mechanismSimple), new ItemStack(ItemsTC.filter), new ItemStack(ItemsTC.alumentum), "nitor", new ItemStack(BlocksTC.vishroom));
	}
